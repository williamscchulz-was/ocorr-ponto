...
- `skeleton-premium.html` — skeleton nas listas pré-carregadas ("teatro calibrado"): variantes sempre / só 1ª visita / só cascata, com o custo em ms visível. Em aprovação.
